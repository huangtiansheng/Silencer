...
source activate hts  
nohup python decentralized.py     --method silencer --aggr avg    --data cifar10  --dis_pruning_aware  &
nohup python decentralized.py     --method silencer --aggr avg    --data cifar10  --non_iid  --dis_pruning_aware &
