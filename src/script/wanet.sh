...
# nohup python decentralized.py   --method fedavg --aggr avg   --data fmnist  --snap 100     &
nohup python decentralized.py   --method fedavg --aggr avg   --data fmnist  --snap 100  --attack wanet     &
nohup python decentralized.py   --method fedavg --aggr avg   --data fmnist  --snap 100  --attack wanet    --non_iid &
# nohup python decentralized.py   --method silencer --aggr avg   --data fmnist  --snap 100  --attack wanet     &
# nohup python decentralized.py   --method silencer --aggr avg   --data fmnist  --snap 100  --attack wanet    --non_iid &
