...
nohup python decentralized.py   --method fedavg --aggr avg   --data cifar10  --snap 100   --poison_frac 0.1  --num_corrupt 10  &
...
nohup python decentralized.py   --method silencer --aggr avg   --data cifar10  --snap 100    --poison_frac 0.1  --num_corrupt 10  &
